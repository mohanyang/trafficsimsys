...
/**
 * Provides routines to access the traffic simulating system configuration.
 */
/**
 * @author Isaac
 * 
...
public final class Config {
	...
	/**
	 * Get the value of a key in <tt>traffic.ini</tt>.
	 * 
	 * @param key
	 *            the key to look up.
	...
	/**
	 * Get the value of a key in <tt>traffic.ini</tt>, returning the
	...
	/**
	 * Get the value of an integer key in <tt>traffic.ini</tt>.
	 * 
	 * @param key
	 *            the key to look up.
	...
	/**
	 * Get the value of an integer key in <tt>traffic.ini</tt>, returning the
	 * specified default if the key does not exist.
	 * 
	 * @param key
	 *            the key to look up.
	...
	/**
	 * Get the value of a double key in <tt>traffic.ini</tt>.
	 * 
	 * @param key
	 *            the key to look up.
	 * @return the value of the specified key.
	...
	/**
	 * Get the value of a double key in <tt>traffic.ini</tt>, returning the
	 * specified default if the key does not exist.
	 * 
	 * @param key
	 *            the key to look up.
	...
	/**
	 * Get the value of a boolean key in <tt>traffic.ini</tt>.
	 * 
	 * @param key
	 *            the key to look up.
	 * @return the value of the specified key.
	...
	/**
	 * Get the value of a boolean key in <tt>traffic.ini</tt>, returning the
	 * specified default if the key does not exist.
	 * 
	 * @param key
	 *            the key to look up.
