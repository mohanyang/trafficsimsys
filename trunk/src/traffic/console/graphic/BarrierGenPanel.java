...
public class BarrierGenPanel extends JFrame implements ActionListener,GenerateConsole{
    ...
    class confirmListener implements ActionListener {
        public void actionPerformed(ActionEvent e) {
        	...
        	if(MyFactory.getInstance().getBarrierGenerator().getInstance().generate()<0){
    ...
    public void paraconfig(int index,Object o){
    	...
    	switch(index){
    	case 0:
    		MyFactory.getInstance().getBarrierGenerator().getInstance().setbornpoint(value);
    		break;
    	default:
